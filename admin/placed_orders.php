...
<div class="box-container">
   ...
   <div class="box">
      ...
      <p> Preço a pagar : <span>$<?= $fetch_orders['total_price']; ?>/-</span> </p>
      ...
      <form action="" method="post">
        ...
        <div class="flex-btn">
         ...
         <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('Deseja apagar o produto?');">Apagar</a>
        </div>
      </form>
   </div>
   <?php
